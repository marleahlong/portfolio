...
lib.ssMetadata = [
		{name:"728x90_atlas_P_", frames: [[0,0,150,150],[0,152,150,150],[0,304,150,150],[0,456,150,150],[0,608,150,150],[0,760,150,150],[152,0,150,150],[152,152,150,150],[152,304,150,150],[152,456,150,150],[152,608,150,150],[152,760,150,150],[304,0,150,150],[304,152,150,150],[304,304,150,150],[304,456,150,150],[304,608,105,30]]}
];
...
(lib._728x90 = function(mode,startPosition,loop) {
			...
			var contentD = [
				{
					...
					"description": "Migrate your on-premises workloads to the cloud with confidence",
	...
	this.txtCta.setTransform(577,26);
	...
	this.cta.setTransform(575.2,23.4,1,1,0,0,0,0.2,0.4);

	this.timeline.addTween(cjs.Tween.get(this.cta).wait(72));

	// headlineText
	this.headlineText = new cjs.Text("Build intelligent apps faster with analytics and built-in AI", "19px 'Segoe Pro Semibold'", "#505050");
	this.headlineText.name = "headlineText";
	this.headlineText.lineHeight = 26;
	this.headlineText.lineWidth = 286;
	...
	this.Serverless.setTransform(187.1,72.6,0.1285,0.1259,60.0001,0,0,390.4,393.4);
	...
	this.StaticDataBrick.setTransform(182.1,44.95,0.098,0.0979,0,0,0,611.1,449.8);

	this.DataBrick = new lib.DataBrick();
	this.DataBrick.name = "DataBrick";
	this.DataBrick.parent = this;
	this.DataBrick.setTransform(182,45,0.0979,0.0978,0,0,0,610.8,450.8);
	...
	this.Square.setTransform(190.4,16.05,0.0972,0.0972,0,0,0,602.9,144.6);
	...
	this.Cube.setTransform(234.1,-103.85,0.75,0.75,0,0,0,241,204);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728x90_atlas_P_.png?1573669900147", id:"728x90_atlas_P_"}
	],
	preloads: []
};
